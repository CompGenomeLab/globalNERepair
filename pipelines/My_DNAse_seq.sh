...
# Users should use their own fastq file location (PATH) instead of above exemplified DIR ("/cta/users/ardacetin/globalRepair/MelanomaPrediction/DNAseI/DNAse-seqProtocolFiles").
...
#	The 4_${NAME}_edited_sorted.bed is downsampled externally using a python script.
